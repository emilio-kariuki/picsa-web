...
const pages = [
  ...
  { icon: UsersIcon, label: 'Users', href: '/admin/dashboard/users' },
  { icon: CreditCardIcon, label: 'Payments', href: '/admin/dashboard/payments' },
  { icon: CalendarDaysIcon, label: 'Events', href: '/admin/dashboard/events' },
  { icon: ImageIcon, label: 'Images', href: '/admin/dashboard/media' },
  { icon: TicketIcon, label: 'Tickets', href: '/admin/dashboard/tickets' },
  { icon: BellIcon, label: 'Notifications', href: '/admin/dashboard/notifications' },
  { icon: SettingsIcon, label: 'Settings', href: '/admin/dashboard/settings' },
  { icon: ClipboardListIcon, label: 'Audit Log', href: '/admin/dashboard/audit-log' },
]
            ...
            <CommandGroup heading="Users">
              {results.users.map((user) => (
                <CommandItem
                  ...
                  onSelect={() => goTo(`/admin/dashboard/users/${user.id}`)}
                >
            ...
            <CommandGroup heading="Events">
              {results.events.map((event) => (
                <CommandItem
                  ...
                  onSelect={() => goTo(`/admin/dashboard/events/${event.id}`)}
                >
          ...
          <CommandGroup heading="Tickets">
            {results.tickets.map((ticket) => (
              <CommandItem
                ...
                onSelect={() => goTo(`/admin/dashboard/tickets/${ticket.id}`)}
              >
