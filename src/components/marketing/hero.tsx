        ...
        <div className="relative h-130 lg:h-150 flex items-center justify-center">
          ...
          >
            <img
              ...
              className="absolute inset-0 h-full w-full object-cover"
            />
            <div className="absolute inset-0 bg-linear-to-t from-foreground/25 to-transparent" />
          </div>
          ...
          {/* Floating chat chip */}
          <div
            className="absolute top-1/2 right-0 -translate-y-1/2 bg-background rounded-2xl shadow-lg px-3 py-2 z-30 border border-border max-w-40"
