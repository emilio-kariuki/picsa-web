...
export function LegalPageShell({
  ...
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-background text-foreground">
      <div className="absolute inset-x-0 top-0 -z-10 h-128 bg-[radial-gradient(circle_at_top,rgba(214,122,92,0.18),transparent_58%)]" />
      <div className={`absolute -right-32 top-24 -z-10 h-72 w-72 rounded-full blur-3xl ${accentStyle.glow}`} />
      <div className="absolute -left-40 top-64 -z-10 h-80 w-80 rounded-full bg-secondary/70 blur-3xl" />
        ...
        <div className="mx-auto flex h-18 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-4">
            <Link to="/" className="group inline-flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-accent text-sm font-bold text-accent-foreground shadow-none">
                P
              </span>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-10 pt-20 md:pt-24">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          ...
          <div className={`relative overflow-hidden rounded-4xl border border-border/70 bg-linear-to-br ${accentStyle.panel} p-6 shadow-[0_24px_80px_rgba(30,30,30,0.08)]`}>
            <div className="absolute inset-x-10 top-0 h-px bg-linear-to-r from-transparent via-foreground/20 to-transparent" />
      ...
      <section className="mx-auto max-w-5xl px-6 pb-24">
        <div className="rounded-4xl border border-border/70 bg-card/90 shadow-[0_20px_60px_rgba(30,30,30,0.06)]">
