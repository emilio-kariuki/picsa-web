    ...
    <>
      <main className="mx-auto max-w-3xl p-5 pb-10 text-lg">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Picsa Pro, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Picsa, San Fransisco.
              Kenya.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Picsa, accessible from{" "}
              <a
                href="https://www.picsa.pro"
        ...
        <ul>
          <li>
            <p>
              By email:{" "}
              <a href="mailto:picsawebsite@gmail.com">
                info@picsa.com
              </a>
            </p>
          </li>
          <li>
            <p>
              ...
              <a
                href="https://www.picsa.pro/privacy"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.picsa.pro/privacy
              </a>
            </p>
          </li>
        </ul>
