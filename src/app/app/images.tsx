    ...
    <div className="space-y-6">
      ...
      <ClientSurface className="rounded-[1.2rem] border-border/60 bg-card/88 p-4 sm:p-5">
        {images.length ? (
                  ...
                  <div className="max-h-[92vh] overflow-y-auto">
                    ...
                    <div className="space-y-5 p-5 sm:p-6">
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        >
                          <Link to="/app/events/$eventId" params={{ eventId: activeImage.eventId }}>
          ...
          <Empty className="rounded-3xl border-border/70 bg-secondary/35 p-10">
            <EmptyHeader>
