...
export function MarketingPaymentReturnContent({
  ...
  return (
    <main className="mx-auto flex min-h-[78vh] w-full max-w-4xl items-center px-6 py-16">
      <section className="w-full overflow-hidden rounded-[2rem] border border-border/60 bg-background/95 shadow-[0_24px_80px_-48px_rgba(0,0,0,0.55)]">
        <div className="grid gap-0 md:grid-cols-[1.15fr_0.85fr]">
          <div className="border-b border-border/50 px-7 py-10 md:border-b-0 md:border-r md:px-10 md:py-12">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-full border border-border/60 px-5 py-2.5 text-sm font-medium transition hover:border-foreground/30 hover:text-foreground"
              >
                Back to Picsa
              </Link>
            </div>
