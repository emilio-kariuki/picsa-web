        ...
        >
          ...
          <div className="absolute inset-0 opacity-10 pointer-events-none select-none">
            <div className="absolute -left-8 top-4 w-40 h-52 rounded-2xl overflow-hidden rotate-[-8deg]">
              <Image src="/images/hero-photo-1.jpg" alt="" fill className="object-cover" />
            </div>
            <div className="absolute -right-6 bottom-4 w-36 h-48 rounded-2xl overflow-hidden rotate-[6deg]">
              <Image src="/images/hero-photo-2.jpg" alt="" fill className="object-cover" />
            </div>
            <div className="absolute left-1/2 -translate-x-1/2 -top-4 w-32 h-44 rounded-2xl overflow-hidden rotate-[2deg] hidden lg:block">
              <Image src="/images/hero-photo-4.jpg" alt="" fill className="object-cover" />
            </div>
          </div>
